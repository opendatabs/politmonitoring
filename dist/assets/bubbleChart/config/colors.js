...
// new colors according to Anforderungskatalog
var COLORS = [
  {color: '#258A00' , themenbereich_1 : 'Bildung'},
  {color: '#FF0080' , themenbereich_1 : 'Gesellschaft & Chancengleichheit'},
  {color: '#505050' , themenbereich_1 : 'Kultur'},
  {color: '#FF85C4' , themenbereich_1 : 'Finanzen & Steuern'},
  {color: '#C7FF00' , themenbereich_1 : 'Gesundheit'},
  {color: '#FFF500' , themenbereich_1 : 'Öffentliche Ordnung & Sicherheit'},
  {color: '#FF0300' , themenbereich_1 : 'Öffentlicher Raum'},
  {color: '#FF7100' , themenbereich_1 : 'Politik & Staat'},
  {color: '#00CBFF' , themenbereich_1 : 'Siedlungsentwicklung'},
  {color: '#9F00FF' , themenbereich_1 : 'Soziale Sicherheit'},
  {color: '#0047FF' , themenbereich_1 : 'Umwelt & Energie'},
  {color: '#00FFD5' , themenbereich_1 : 'Verkehr & Mobilität'},
  {color: '#FFCC00' , themenbereich_1 : 'Wirtschaft & Arbeit'},
];
